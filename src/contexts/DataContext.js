...
export const DataProvider = ({ children }) => {
  ...
  const getProductDetailsById = (id) => console.log({products,id})||products.find(product => product.id == id)
